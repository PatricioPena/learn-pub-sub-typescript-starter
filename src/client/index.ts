...
import { ExchangePerilDirect, PauseKey, WarRecognitionsPrefix } from "../internal/routing/routing.js";
...
async function main() {
  ...
  await subscribeJSON(conn, ExchangePerilTopic, "war",`${WarRecognitionsPrefix}.*`, SimpleQueueType.Durable, handlerWar(newGame));
